/**
 * An abstract data access layer for technology features.
 *
 * @date                    01 06 2016
...
#ifndef IAS_FEATURE_DATA_ACCESS_H_
#define IAS_FEATURE_DATA_ACCESS_H_

namespace ias {

class feature_data_access : public data_access<ias::feature *> {
    ...
    feature_data_access(void) = default;

    // END Constructor. //////////////////////////////////////////////////////

    // BEGIN Destructor. /////////////////////////////////////////////////////

    virtual ~feature_data_access(void) = default;
