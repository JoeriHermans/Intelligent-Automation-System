/**
 * A command which tells the NLP engine to process the specified sentence(s).
 *
 * @date                    9 April, 2015
...
class CommandSay : public Command {
    ...
    /**
     * The command which initiates the NLP engine.
     */
    const static char kIdentifier[];
    ...
    virtual ~CommandSay( void ) = default;
