...
#ifndef POSTGRESQL_STATEMENT_H_
#define POSTGRESQL_STATEMENT_H_
...
class PostgresqlStatement : public DatabaseStatement {
    ...
    virtual ~PostgresqlStatement( void );
